                ...
                <tr class="row<?php echo $i % 2; ?>">
                  ...
                  <th scope="row" class="has-context title-cell">
                    <?php if($canCheckin && $item->checked_out > 0) : ?>
                      <button class="js-grid-item-action tbody-icon" data-item-id="cb<?php echo $i; ?>" data-item-task="userform.checkin">
                  ...
                  <?php if($canEdit || $canDelete): ?>
                    ...
                    <?php endif; ?>
                    <?php if ($canDelete): ?>
                      <button class="js-grid-item-delete tbody-icon <?php echo $disabled; ?>" data-item-confirm="<?php echo Text::_('JGLOBAL_CONFIRM_DELETE'); ?>" data-item-id="cb<?php echo $i; ?>" data-item-task="Userform.remove" <?php echo $disabled; ?>>
                  ...
                  <td class="d-none d-lg-table-cell text-center">
                    <?php if($canChange): ?>
                      ...
                      <button class="js-grid-item-action tbody-icon <?php echo $disabled; ?>" data-item-id="cb<?php echo $i; ?>" data-item-task="Userform.<?php echo $statetask; ?>" <?php echo $disabled; ?>>
