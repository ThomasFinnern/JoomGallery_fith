              ...
              <span id="filteredBy"><?php echo Text::_('JGLOBAL_FILTERED_BY'); ?></span>
                  ...
                  <?php endif; ?>
                      ...
                      <?php
                        ...
                        // echo $title;
                      ?>
<!--                      <a href="--><?php //echo Route::_('index.php?option=com_joomgallery&view=category&id=' . (int) $item->id); ?><!--">--><?php //echo $this->escape($item->title); ?><!-- (--><?php //echo $this->escape($item->id); ?><!--)</a>-->
                      <a href="<?php echo Route::_('index.php?option=com_joomgallery&usercategory&layout=edit&id=' . (int) $item->id); ?>"><?php echo $this->escape($item->title); ?> (<?php echo $this->escape($item->id); ?>)</a>
									</th>
